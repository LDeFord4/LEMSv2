...
if avgData
    ...
    datesAvg = decimate(dates, 10); %need to fix
    date_plotAvg = (datetime(datevec(datesAvg))); %need to fix
end
...
if plotCR3000
    ...
    if avgData
        ...
        CR3000_TimeAvg = decimate(CR3000_Time, 10); %need to fix
        date_plot3Avg = (datetime(datevec(CR3000_TimeAvg))); %need to fix
    end
end
...
if plotTemp
    ...
    legend('MLX Surface1', 'MLX Surface2', 'CR3000');  %need to update if have only 1 LEMS data set
        %'PTemp', 'TT', 'SBT');
