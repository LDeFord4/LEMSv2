...
const double liConst = 5.258E-8;  // Licor Calibration Constant. Units of (Amps/(W/m^2))
const double ampResistor = 64900;        // Exact Resistor Value used by Op-Amp in Ohms
